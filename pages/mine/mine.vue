<template name="mine">
	<view>
		...
		<!-- 头部 -->
		<view class=" flex justify-between padding align-center" style="background-image: url(../../static/mine/bg_img.png);background-size: 100% 100%;">
			<view class="flex align-center">
				<view class="cu-avatar round lg" style="background-image:url(https://ossweb-img.qq.com/images/lol/web201310/skin/big10001.jpg)"></view>
				<view class="margin-left-sm text-white">晴桅</view>
			</view>
		...
		<view class="padding-lr flex flex-direction">
			<button class="cu-btn line-orange radius margin-tb-sm">退出登录</button>
		</view>
		<!-- 底部导航栏Tabbar -->
